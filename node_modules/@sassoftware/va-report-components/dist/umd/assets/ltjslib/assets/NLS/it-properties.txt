...
com.sas.graphics.gtl.nodeLinkDiagram.treeDiagram.txt=Diagramma ad albero
...
com.sas.graphics.gtl.layoutOverlay.waterfallChart.txt=Grafico a cascata
...
com.sas.graphics.gtl.impl.renderer.layoutOverlay.barChart.BarChartRenderer.BASELINEINTERCEPT.txt=L’opzione BASELINEINTERCEPT= viene ignorata quando è usata l’opzione GROUPDISPLAY=STACK o GROUP100=POSITIVE|MAGNITUDE. La linea di base verrà tracciata al valore predefinito.
...
com.sas.graphics.gtl.impl.renderer.layoutOverlay.heatmapParm.HeatmapParmRenderer.continuousLegend.fmt.txt=L’istruzione CONTINUOUSLEGEND fa riferimento a un diagramma con il nome ({0}) che non è assegnato ad alcun diagramma. Il nome sarà ignorato.
...
proxies.label.attrPriority.txt = Rotazione stile elemento di dati
proxies.label.axisLabel.txt = Etichetta asse
proxies.label.axisLine.txt = Linea asse
...
proxies.label.gridLines.txt = Linee griglia
...
proxies.label.otherColor.txt = Altro colore
...
proxies.label.textStyle.dataValue.txt = Stile testo valore dei dati
proxies.label.tickAlignment.txt = Allineamento
proxies.label.tickMarks.txt = Tacche
proxies.label.tickValues.txt = Valori tacche
...
proxies.colors.line.axis.txt = Colore della linea degli assi
...
proxies.groupingStyle.multiple.txt = Multiplo
...
proxies.groupingStyle.stackFilled.txt = In pila con riempimento
...
roleName.TIME_MEASURE1_VAR.txt = Misura (serie storiche)
roleName.TIME_MEASURE2_VAR.txt = Misura (serie storiche 2)
...
locale.not.null.txt=Occorre specificare l’impostazione locale
...
weekday.names.not.null.txt=Occorre specificare lo stile e il contesto del nome per i nomi dei giorni della settimana
cldrVersion=43
...
Asia/Shanghai=Pechinotz0=Americhe;America del Nord;-36000;Adak;America/Adak;US;-1763929;+515248
...
bird.data.role.ANIMATION_VAR.txt = Animazione
...
bird.data.role.TIME_MEASURE1_VAR.txt = Misura (serie storiche 1)
bird.data.role.TIME_MEASURE2_VAR.txt = Misura (serie storiche 2)
...
bird.data.format.ZAR.txt=Sud Africa
...
bird.error.data.noResponseFromServer.txt = La richiesta di dati del server non è stata soddisfatta. I dati dell’oggetto del report potrebbero risultare mancanti o incompleti. Accertati che sia disponibile una connessione di rete come una rete Wi-Fi, dati o di altro tipo.
