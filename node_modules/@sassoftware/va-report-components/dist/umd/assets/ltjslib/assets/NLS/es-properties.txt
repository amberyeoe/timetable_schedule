...
com.sas.graphics.gtl.nodeLinkDiagram.treeDiagram.txt=Diagrama de árbol
...
com.sas.graphics.gtl.layoutOverlay.waterfallChart.txt=Gráfico de cascada
...
com.sas.graphics.gtl.layoutOverlay.bubblePlot.txt=Diagrama de burbujas
...
com.sas.graphics.gtl.layoutOverlay.needlePlot.txt=Gráfico de aguja
...
com.sas.graphics.gtl.impl.renderer.layoutOverlay.barChart.BarChartRenderer.BASELINEINTERCEPT.txt=BASELINEINTERCEPT=option no se tendrá en cuenta cuando se utilice la opción GROUPDISPLAY=STACK o la opción GROUP100=POSITIVE|MAGNITUDE. La línea de referencia se trazará en el valor predeterminado.
...
com.sas.graphics.gtl.layoutRegion.mosaicPlot.duplicateValue.txt=El gráfico de mosaicos ha encontrado valores de categoría duplicados y no se pueden mostrar.
...
dataVisualizations.BubblePlot.txt = Diagrama de burbujas
...
dataVisualizations.MapRegionLayer.txt = Gráfico de región (solo geo)
dataVisualizations.ContourPlot.txt = Gráfico de contorno (solo geo)
...
proxies.label.otherSlice.txt = Crear la capa “Otros” para los valores mínimos
...
proxies.groupingStyle.multiple.txt = Múltiple
...
proxies.groupingStyle.stack.txt = Apilar
proxies.groupingStyle.stackFilled.txt = Apilado relleno
...
proxies.scale.thousands.txt = Miles
...
multiQueryDataMatrix.error.txt = No se permiten datos de detalle y datos sumarizados en el mismo gráfico cuando se estén utilizando roles de cuadrícula de datos. Además, todos los elementos gráficos dentro de una cuadrícula basada en datos deben utilizar la misma sumarización de datos.<br/><br/>Este gráfico no se puede guardar hasta que no se realicen los cambios en los roles.<br/><br/>Puede realizar cualquiera de las siguientes acciones:<ol><li>Quitar los roles de cuadrícula basados en datos o</li><li>Utilizar la misma sumarización de datos para todos los elementos gráficos</li></ol>
...
locale.not.null.txt=La configuración regional no debe estar vacía
...
weekday.names.not.null.txt=El estilo y el contexto del nombre no pueden estar vacíos para los nombres de días de la semana
cldrVersion=43
...
Asia/Shanghai=Pekíntz0=América;Norteamérica;-36000;Adak;America/Adak;US;-1763929;+515248
...
bird.data.role.ANIMATION_VAR.txt = Animación
...
bird.data.role.SIZE_VAR.txt = Tamaño
...
bird.types.bubbleChangePlot.txt = Diagrama de cambio de burbuja
bird.types.bubblePlot.txt = Diagrama de burbujas
...
bird.error.data.noResponseFromServer.txt = No se cumplió una solicitud de datos del servidor. Podrían faltar datos del objeto del informe o no estar completos. Compruebe que existe una conexión de red disponible, ya sea una red wifi, de telefonía móvil o de otro tipo.
...
bird.autotitle.size.txt=Tamaño
...
bird.autotitle.template.geo.coordinates.size.txt=Mapa geográfico de área geográfica dimensionado por tamaño
