...
com.sas.graphics.gtl.nodeLinkDiagram.treeDiagram.txt=Diagramme de l’arbre
...
com.sas.graphics.gtl.layoutOverlay.waterfallChart.txt=Graphique en cascade
...
dataVisualizations.MapRegionLayer.titleInReport.txt = Courbe de région
...
proxies.label.dataLabelValue.txt = Valeur réalisée
...
proxies.label.otherColor.txt = Autre couleur
...
proxies.direction.counterclockwise.txt = Dans le sens contraire des aiguilles d’une montre
...
proxies.groupingStyle.stackFilled.txt = Pile remplie
...
proxies.linePattern.pattern.fmt = Modèle {0}
...
proxies.overlapHandling.rotate.txt = Rotation
...
proxies.overlapHandling.staggerTruncateDropAll.txt = Échelonner, tronquer, supprimer tout
proxies.overlapHandling.truncate.txt = Tronquer
proxies.overlapHandling.truncateRotate.txt = Tronquer, faire pivoter
...
multiQueryDataMatrix.error.txt = Les données de détail et de synthèse ne sont pas autorisées dans le même graphique lorsque des rôles de treillis de données sont utilisés. De même, tous les éléments de graphique d’un treillis piloté par les données doivent utiliser la même synthèse de données.<br/><br/>Ce graphique ne peut pas être sauvegardé tant que des modifications ne sont pas apportées à ses rôles.<br/><br/>Vous pouvez effectuer l’une des opérations suivantes :<ol><li>Supprimer les rôles en treillis pilotés par les données ou</li><li>Utiliser la même synthèse de données pour tous les éléments du graphique</li></ol>
...
roleName.HIGH_VAR.txt = Élevé
roleName.LOW_VAR.txt = Faible
roleName.CLOSE_VAR.txt = Fermer
...
locale.not.null.txt=Vous devez indiquer le paramètre régional
...
weekday.names.not.null.txt=Vous devez indiquer le style et le contexte des noms de jours
cldrVersion=43
...
Asia/Shanghai=Pékintz0=Amériques;Amérique septentrionale;-36000;Adak;America/Adak;US;-1763929;+515248
